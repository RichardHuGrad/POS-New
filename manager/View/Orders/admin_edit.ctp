	        ...
	        <div class="orders form">
      			<?php echo $this->Form->create('Order'); ?>
      				...
      				//  echo $this->Form->input('order_no', array('label' => array('class' => 'col-sm-2 control-label'),'style'=>'width:200px;'));
      					...
      					echo $this->Form->input('table_status', array('label' => array('class' => 'col-sm-2 control-label'),'style'=>'width:200px;'));
      					...
      					echo $this->Form->input('order_type', array('label' => array('class' => 'col-sm-2 control-label'),'style'=>'width:200px;'));
      					...
      					echo $this->Form->input('is_completed', array('label' => array('class' => 'col-sm-2 control-label'),'style'=>'width:200px;'));
