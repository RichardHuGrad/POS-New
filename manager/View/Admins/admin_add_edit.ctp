                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        for($i = 1; $i <= 50; $i++)
                                            $options[$i] = $i;
                                        echo $this->Form->input('no_of_tables', array('options'=>$options, 'type' => 'select', 'maxlength' => '200', 'class' =>'form-control', 'div' => false, 'label' => false,'default'=>'Please Select',  'required' => true)); ?>
                                    </div>
                                </div>
