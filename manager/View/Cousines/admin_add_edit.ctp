                    ...
                    <div class="row">
                        <div class="col-md-12">   
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Is Tax Applicable</label>
                                        <?php
                                        $tax_status = $arrayName = array('Y' => 'Yes', 'N'=>'No' );
                                         echo $this->Form->input('is_tax', array('options' => $tax_status, 'class' => 'form-control', 'empty' => false, 'label' => false, 'div' => false)); ?>
                                    </div>
                                </div>
