...
define('WEBSITE_URL', $url_directory);
define('WEBSITE_FRONT_CSS', WEBSITE_URL."css/front/");
define('WEBSITE_FRONT_JS', WEBSITE_URL.'js/front/');
define('WEBSITE_FRONT_IMAGE', WEBSITE_URL.'img/front/');



define('TMP_PATH', $directory.'manager/webroot/uploads/temp/');
define('COUSINE_UPLOAD_PATH', $directory.'manager/webroot/uploads/cousine_images/');
define('COUSINE_IMAGE_PATH', $url_directory.'manager/uploads/cousine_images/thumbnail/');


define('CASHIER_UPLOAD_PATH', $directory.'manager/webroot/uploads/cashier/');
define('CASHIER_IMAGE_PATH', $url_directory.'manager/uploads/cashier/thumbnail/');
