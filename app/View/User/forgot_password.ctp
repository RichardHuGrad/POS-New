<div class="container">
	...
	<div class="text-center forget-txt"><a href="<?php echo $this->Html->url(array('plugin' => false,'controller' => 'user','action' => 'login')); ?>"><?php echo __("Already have an account?"); ?></a></div>
	</form>
    </div>
</div>
