...
<div class="" ng-app="paymentApp" ng-controller="paymentCtrl">
    <keyboard></keyboard>
    <order-detail></order-detail>
</div>

<?php
echo $this->Html->script(array('jquery.min.js', 'bootstrap.min.js', 'jquery.mCustomScrollbar.concat.min.js', 'barcode.js', 'epos-print-5.0.0.js', 'fanticonvert.js', 'jquery.kinetic.min.js', 'notify.min.js', 'flowtype.js', 'angular/paymentApp.js', 'angular/controllers/paymentCtrl.js','angular/components/keyboard.js', 'angular/components/orderDetail.js'));
