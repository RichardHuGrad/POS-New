...
?>';
                    ...
                    $.ajax({
                    url: "<?php echo $this->Html->url(array('controller' => 'homes', 'action' => 'printMergeReceipt', (($type == 'D') ? '[[Dinein]]' : (($type == 'T') ? '[[Takeout]]' : (($type == 'W') ? '[[Waiting]]' : ''))) . ' #' . $table, $cashier_detail['Admin']['service_printer_device'])); ?>",
                            method:"post",
                            data:{
